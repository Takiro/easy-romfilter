...
The program itself needs no installation. Since it is written in python it should run without an issue on any Operation System with python support. A lot of Linux distributions already ship with python installed. You probably need to install python on Windows, Mac OS and other Operating Systems, first.  
...
$ `python easy-romfilter.py -vvv --simulate -e smc roms/ n64_filtered/`  
